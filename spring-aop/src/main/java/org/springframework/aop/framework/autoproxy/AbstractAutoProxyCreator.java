...
public abstract class AbstractAutoProxyCreator extends ProxyProcessorSupport
	...
	@Override//循环应用 此方法暴露在二级factory中，需要在半成品bean被其他bean依赖时，进行aop代理对象的返回
	public Object getEarlyBeanReference(Object bean, String beanName) throws BeansException {
		Object cacheKey = getCacheKey(bean.getClass(), beanName);
		// 还没被代理的原始bean当作一个缓存存储，主要是为了在后置处理的aop处判断，不要重复aop
	 ...
	 * @see #getAdvicesAndAdvisorsForBean
	 */
	// 后置处理，和238行的getEarlyBeanReference 方法一摸一样，为何？
	// 因为getEarlyBeanReference是在getSingleton中获取在二级缓存中的singletonFactories中的getObject时产生的代理对象
	// 这个是在bean后置处理时产生的代理对象
	// 俩个方法都是产生代理对象，代码都一样一样的，分别啥场景使用呢？
	@Override
	...
	protected Object wrapIfNecessary(Object bean, String beanName, Object cacheKey) {
		...
		// 获取这个 bean 的 advice   (根据beanName拿到需要增强的点)
